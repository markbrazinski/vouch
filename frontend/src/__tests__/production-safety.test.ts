...
describe('the product surface carries no demo apparatus', () => {
  ...
  it('references only the CANONICAL qualified supplier PDF', () => {
    ...
    const CANONICAL =
      /(northern-alloys-coa-lot-1001|eastern-metals-coa-lot-1002|northern-alloys-coa-batch-wp-26-0317-b|central-forgeworks-coa-lot-1005|western-polymers-coa-lot-1003)\.pdf/;
    for (const f of productFiles) {
      const src = readFileSync(f, 'utf8');
