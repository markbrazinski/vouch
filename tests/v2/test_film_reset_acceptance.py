...
the claim: execute -> record exists -> reset -> only LOT-1003 moved -> the old
...
UNRELATED_LOTS = ("LOT-1001", "LOT-1002", "LOT-1004", "LOT-1005", "LOT-1007", "LOT-8001")
...
def test_the_full_film_reset_acceptance_sequence():
    ...
    # (1) execute LOT-1003 to a terminal state
    ...
    # (4) only LOT-1003 returns to canonical pre-decision state
    assert corpus.get("lot", "LOT-1003").status == "RECEIVED"
